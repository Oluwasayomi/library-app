...
Afterwards, I worked on the styling based on the screen size, ensuring the website was adaptable for PC, tablet, and phone views. I also added scrolling functions, button animations, and other event listeners to make the website more interactive. I also made the pop-up login/register form and other necessary adjustments to ensure the website was responsive 
